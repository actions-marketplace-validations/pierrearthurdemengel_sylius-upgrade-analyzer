...
class AdminController
{
    ...
    public function getPaymentGateways(): string
    {
        return $this->generateUrl('sylius_admin_get_payment_gateways');
    }

    public function generateSlug(): string
    {
        return $this->generateUrl('sylius_admin_ajax_generate_product_slug');
    }

    public function getTaxonLeafs(): string
    {
        return $this->generateUrl('sylius_admin_ajax_taxon_leafs');
    }

    public function renderAttributeForms(): string
    {
        return $this->generateUrl('sylius_admin_render_attribute_forms');
    }
}
